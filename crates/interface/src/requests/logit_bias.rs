...
impl LogitBias {
    ...
    pub(crate) fn build_openai(&mut self, tokenizer: &Arc<Tokenizer>) -> crate::Result<()> {
    ...
    fn build_base(&mut self, tokenizer: &Arc<Tokenizer>) -> crate::Result<()> {
...
impl FromTokenIds {
    ...
    fn get(&self, tokenizer: &Arc<Tokenizer>) -> crate::Result<HashMap<u32, f32>> {
